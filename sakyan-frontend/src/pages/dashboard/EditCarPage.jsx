...
export default function EditCarPage() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-2xl mx-auto space-y-6 animate-pulse pb-10">
        <div className="flex gap-4 items-center">
            <div className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-xl" />
            <div className="space-y-2 flex-1">
                <div className="h-6 bg-gray-200 dark:bg-gray-800 rounded-lg w-1/4" />
                <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-lg w-1/3" />
            </div>
        </div>
        <div className="h-64 bg-white dark:bg-[#1a1d2e] rounded-2xl border border-gray-100 dark:border-gray-800" />
        <div className="h-40 bg-white dark:bg-[#1a1d2e] rounded-2xl border border-gray-100 dark:border-gray-800" />
      </div>
    )
  }
    ...
    <div className="max-w-2xl mx-auto pb-10">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Update your car listing details.</p>
        </div>
      </div>
